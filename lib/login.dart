...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _buildTextField(String label, TextInputType inputType, Function(String) onChanged) {
    return Container(
  ...
  Widget _buildPasswordField(String label, TextInputType inputType, Function(String) onChanged) {
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 16.0),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
